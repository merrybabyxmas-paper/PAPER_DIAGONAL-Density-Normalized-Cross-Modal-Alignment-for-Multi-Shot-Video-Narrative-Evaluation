...
In Theorem~3.1 (main text), we established that $\{\calB_1, \calB_2\}$ spans $\mathbb{M}_{2 \times 3}(\mathbb{Z})$. To avoid redundancy with the main text's constructive proof, we provide the formal algebraic proof of why $\calB_1$ (Relay) alone is strictly insufficient to span the space, thereby necessitating the introduction of $\calB_2$ (Split).
...
\begin{align}
\mathbb{Z}_N(X) = \bigl[\; X \;\;\; \mathbf{0}_{2\times(N-3)} \;\bigr], \quad X \in \mathbb{M}_{2\times 3}.
\end{align}
