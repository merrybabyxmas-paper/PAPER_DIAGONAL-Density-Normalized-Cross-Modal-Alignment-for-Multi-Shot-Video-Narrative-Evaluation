...
Under character role swapping $\calP_{ij}$ and integer-coefficient linear combination, the two basis matrices $\calB_1$ (Relay) and $\calB_2$ (Split) span $\mathbb{M}_{2 \times 3}(\mathbb{Z})$.
\end{theorem}
...
Apply character role swapping: $\calP_{12}(\calB_2) = -E_{11} + E_{21} - E_{22}$.
Adding to $X$:
\begin{equation}
...
From $E_{22}$, character role swapping yields $E_{21} = \calP_{12}(E_{22})$ and $E_{23} = \calP_{23}(E_{22})$.
